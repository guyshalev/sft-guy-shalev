...
import wavPackage.WavFile;
	...
	public static void main(String[] args)
	{
		try
		{
			...
			String Name = "C:/Sadna/FinalOutputA1.wav";
			...
			segment = 15; //number of segment we want to see.
			...
			System.out.println("min: " + attr[0]);
			System.out.println("max: " + attr[1]);
			System.out.println("avg: " + attr[2]);
			System.out.println("var: " + attr[3]);
